...
namespace Temperature_Sensor {
    ...
    public class Setting {
        ...
        public int TestFailedQty { get; set; } // 连续几辆车检测失败将提示报警
        ...
        public int Rule { get; set; } // 是否合格的评判标准，0：绝对值，1：平均值，2：连续点，0即为温度设定绝对值，1/2为计算温差系数
        public double SetupValue { get; set; } // 温度设定值，用于计算设定温度，小于1为比率，大于1为绝对值，该设定值同时用于判定标准的三种情况
